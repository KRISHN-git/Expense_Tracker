...
const LoginPage = () => {
    // ... state and handlers ... (keeping existing logic, just updating UI)
    ...
    return (
        <>
            ...
            >
                ...
                <motion.div variants={itemVariants} className="flex justify-end mt-1 mb-4">
                    <a href="#" className="text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Forgot password?</a>
                </motion.div>
